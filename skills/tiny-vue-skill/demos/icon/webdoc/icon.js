export default{column:'1',owner:'',show:true,cloud:true,demos:[{demoId:'basic-usage',name:{'zh-CN':'基本用法','en-US':'Basic Usage'},desc:{'zh-CN':`
        ...
        `,'en-US':`
          ...
          `},codeFiles:['basic-usage.vue']},{demoId:'show-title',name:{'zh-CN':'显示 Title','en-US':'Display Title'},desc:{'zh-CN':'图标组件自身上指定 <code>title</code> 属性无效\uFF0C需要通过其父元素的 <code>title</code> 属性实现提示功能\u3002','en-US':'The <code>title</code> attribute specified on the icon component is invalid. You need to give the <code>title</code> attribute of its parent element to realize the prompt function.'},codeFiles:['show-title.vue']},{demoId:'advance-icons',name:{'zh-CN':'标准图标合集','en-US':'Icon Set'},desc:{'zh-CN':`Saas业务梳理 600 多个标准图标，Saas业务的应用必须使用标准图标。它新增了三大功能：支持线性、面性图标切换，支持双色切换和托底效果。<br>
                  ...
                  Set the bottoming effect of the icon through the <code>underlay</code> attribute. Default style: {background: '#dbdbdb', borderRadius: '4px', scale:0.6} <br>`},codeFiles:['advance-usage.vue'],hidePc:true},{demoId:'list',name:{'zh-CN':'图标集合','en-US':'Icon Set'},desc:{'zh-CN':'输入图标名称进行搜索\uFF0C点击图标即可快速复制名称\u3002','en-US':'Enter the icon name for search, Click on the icon to quickly copy the name.'},codeFiles:['list.vue']}],features:[{id:'basic',name:'基本用法',support:{value:true},description:'通过 name 设置图标名称\uFF0Csize 设置图标大小\u3002',cloud:{value:true},apis:['name','size'],demos:['basic-usage']},{id:'color',name:'颜色配置',support:{value:true},description:'通过 color 设置图标颜色\u3002',cloud:{value:true},apis:['color'],demos:['custom-color']},{id:'animation',name:'动画效果',support:{value:true},description:'通过 animation 设置图标动画效果\uFF0C可选值\uFF1Aspin\u3001pulse\u3001bounce\u3002',cloud:{value:true},apis:['animation'],demos:['animation']},{id:'rotation',name:'旋转',support:{value:true},description:'通过 rotation 设置图标旋转角度\u3002',cloud:{value:true},apis:['rotation'],demos:['rotation']},{id:'flip',name:'翻转',support:{value:true},description:'通过 flip 设置图标翻转方向\uFF0C可选值\uFF1Ahorizontal\u3001vertical\u3002',cloud:{value:true},apis:['flip'],demos:['flip']},{id:'events',name:'事件',support:{value:true},description:'支持 click 事件\u3002',cloud:{value:true},apis:['click'],demos:['events']}]};